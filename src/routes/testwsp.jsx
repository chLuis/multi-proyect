  ...
  return(
    <main className="windowsWspFake">
      <div className='loading'>
        <div>
          <div className='loadingContainerSVG'>
            <div className='animacionWSP'>
              <svg  xmlns="http://www.w3.org/2000/svg"  width="66"  height="66"  viewBox="0 0 24 24"  fill="none"  stroke="gray"  strokeWidth="1.5"  strokeLinecap="round"  strokeLinejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-brand-whatsapp"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 21l1.65 -3.8a9 9 0 1 1 3.4 2.9l-5.05 .9" /><path d="M9 10a.5 .5 0 0 0 1 0v-1a.5 .5 0 0 0 -1 0v1a5 5 0 0 0 5 5h1a.5 .5 0 0 0 0 -1h-1a.5 .5 0 0 0 0 1" /></svg>
            </div>
          </div>
          <div className='lineCharge'>
            <div className='lineBackGround'></div>
            <div className='animacionCarga'></div>
          </div>
          <div className='boxLoadingText'>
            <div className='loadingWhatsAppText'>WhastApp</div>
            <div className='loadingCifrado'>
              <span>
      ...
      <section className="bigBox">
          ...
          <div className='boxChatList'>
            ...
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/261335828_3316659591896363_2721560237110125818_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIDlljwEx9jHFJjXylhntGSZ0vKvnSPgTPEljxhlbZUGw&oe=663D2BC9&_nc_sid=e6ed6c&_nc_cat=102" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
                    <p className='nameChatList'>Mamá</p>
            ...
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/301439940_116500521203102_3299349136476507305_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIJcvmoEUSc-sSCiKBrAI7Mi56Ce8lJCppKRiOxaTNZS7&oe=663D2A56&_nc_sid=e6ed6c&_nc_cat=108" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
                    ...
                    <span className='spanChat'>
                      Mañana se juega a la pelota, vas?
                    </span>
                    </p>
                  </div>
                  <div className='hourShowMore'>
            ...
            <label htmlFor='chat3' name='chat3'>
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/425546086_1609855713150481_5740327734460443682_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIF_PnuTo7zNL3AyV7VAlzKRvlYhVpWB-64tSKX1F1fix&oe=664605EC&_nc_sid=e6ed6c&_nc_cat=102" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
            ...
            <label htmlFor='chat4' name='chat4'>
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/370537000_139984202508088_3619165344788927939_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaILQ-t3hu50G3DN1SsfwOlPmQrNZDi-ZyrKOErLXNoI2x&oe=663D3D4C&_nc_sid=e6ed6c&_nc_cat=109" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
                    ...
                    <p className='textChatList'>
                    <span>
                      <svg viewBox="0 0 18 18" height="20" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="#4ba9d2" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                    </span>
                    <span className='spanChat'>
                    Espero que estos no defrauden jaja
                    </span>
                    </p>
                  </div>
                  <div className='hourShowMore'>
            ...
            <label htmlFor='chat5' name='chat5'>
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/161974473_414581580487797_3682940019197293250_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIJ9ZtLmv8ttm-eVes2kQYoJL14lmP3427Y99ZnoP9VUN&oe=66467F4A&_nc_sid=e6ed6c&_nc_cat=110" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
            ...
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/256947678_1316461958821260_4355380543494983824_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIOE7mIlH_4fIr48E02qZnMzWumtPyD6AWLnCwr0vg4xH&oe=66460F4A&_nc_sid=e6ed6c&_nc_cat=100" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
            ...
            <label htmlFor='chat8' name='chat8'>
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/344455381_1030183248354722_5799318174052758271_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIIv2uDEJABtMx9J570KfUo4cEuoPc8GjFdnWHnHvfkj7&oe=6641CC76&_nc_sid=e6ed6c&_nc_cat=111" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
            ...
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/56910282_338615493457476_4604954670803189760_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIDanxgZ86ZL7Yvzs9nBQy8wQpCvdUeOTgtyj5OiSTae9&oe=663D5276&_nc_sid=e6ed6c&_nc_cat=100" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
            ...
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/425112536_388521983759889_2240825185364318291_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaID3bMgpe0q7RRbHSvPyxImLYfSz5Eg1Wkpz7RPN9fpxs&oe=66462269&_nc_sid=e6ed6c&_nc_cat=106" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
            ...
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/414684567_910333407438686_3830408864275790330_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaII5iwfmdVwBNZvS9HJBNvCVefvujQbjturR2XmVkeiKj&oe=663D1D56&_nc_sid=e6ed6c&_nc_cat=103" />
              </div>
              <div className='boxChatTextPreview'>
                <div className='boxChatText'>
                  <div className='chatText'>
                    <p className='nameChatList'>Joa</p>
                    <p className='textChatList'>
                    <span>
                      <svg viewBox="0 0 18 18" height="20" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="#4ba9d2" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                    </span>
            ...
            <div className='boxChatPreview'>
              <div className='pictureChat'>
                <img src="https://media-eze1-1.cdn.whatsapp.net/v/t61.24694-24/422833534_1436294136970509_3804214950904239737_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_Q5AaIGYyH0UycLAQD2kR1JhvCPpYoolWSehHA5aNUxrjGtr3&oe=6641DCCB&_nc_sid=e6ed6c&_nc_cat=101"/>
              </div>
            ...
            <div className='containerChat'>
              ...
              <div className='chatIndividual'>
                ...
                <div className='chatI'>
                  ...
                  <div className='reaccionarChatI'>
                  <div className='floating'>
                  <div className='verMasOp'><span>👍🏼</span><span>💖</span><span>😄</span><span>😮</span><span>😭</span><span>🙏🏼</span><span>➕</span></div>
                  <svg viewBox="0 0 15 15" width="16" preserveAspectRatio="xMidYMid meet" fill="none"><title>react</title><path fillRule="evenodd" clipRule="evenodd" d="M0 7.5C0 11.6305 3.36946 15 7.5 15C11.6527 15 15 11.6305 15 7.5C15 3.36946 11.6305 0 7.5 0C3.36946 0 0 3.36946 0 7.5ZM10.995 8.69333C11.1128 8.67863 11.2219 8.66503 11.3211 8.65309C11.61 8.63028 11.8076 8.91918 11.6784 9.13965C10.8573 10.6374 9.29116 11.793 7.50455 11.793C5.71794 11.793 4.15181 10.6602 3.33072 9.16246C3.18628 8.91918 3.37634 8.63028 3.66524 8.65309C3.79123 8.66749 3.93521 8.68511 4.09426 8.70457C4.94292 8.80842 6.22074 8.96479 7.48174 8.96479C8.81855 8.96479 10.1378 8.80025 10.995 8.69333ZM5.41405 7.37207C6.05761 7.37207 6.60923 6.72851 6.60923 6.02978C6.60923 5.30348 6.05761 4.6875 5.41405 4.6875C4.77048 4.6875 4.21886 5.33106 4.21886 6.02978C4.20967 6.75609 4.77048 7.37207 5.41405 7.37207ZM10.7807 6.05619C10.7807 6.74114 10.24 7.37201 9.60912 7.37201C8.97825 7.37201 8.4375 6.76818 8.4375 6.05619C8.4375 5.37124 8.97825 4.74037 9.60912 4.74037C10.24 4.74037 10.7807 5.34421 10.7807 6.05619Z" fill="gray"></path></svg>
                  </div>
                  </div>
                  <p className='textChatInGloboI'>Ok</p>
                  <p className='hourGlobo'>
                    21:50
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                </div>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Salgo pasadas las 22:30</p>
                  <p className='hourGlobo'>
                    21:52
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  <div className='colitaChatU'></div>
                  <div className='reaccionarChatU'>
                  <div className='floating'>
                  <div className='verMasOp'><span>👍🏼</span><span>💖</span><span>😄</span><span>😮</span><span>😭</span><span>🙏🏼</span><span>➕</span></div>
                  <svg viewBox="0 0 15 15" width="16" preserveAspectRatio="xMidYMid meet" fill="none"><title>react</title><path fillRule="evenodd" clipRule="evenodd" d="M0 7.5C0 11.6305 3.36946 15 7.5 15C11.6527 15 15 11.6305 15 7.5C15 3.36946 11.6305 0 7.5 0C3.36946 0 0 3.36946 0 7.5ZM10.995 8.69333C11.1128 8.67863 11.2219 8.66503 11.3211 8.65309C11.61 8.63028 11.8076 8.91918 11.6784 9.13965C10.8573 10.6374 9.29116 11.793 7.50455 11.793C5.71794 11.793 4.15181 10.6602 3.33072 9.16246C3.18628 8.91918 3.37634 8.63028 3.66524 8.65309C3.79123 8.66749 3.93521 8.68511 4.09426 8.70457C4.94292 8.80842 6.22074 8.96479 7.48174 8.96479C8.81855 8.96479 10.1378 8.80025 10.995 8.69333ZM5.41405 7.37207C6.05761 7.37207 6.60923 6.72851 6.60923 6.02978C6.60923 5.30348 6.05761 4.6875 5.41405 4.6875C4.77048 4.6875 4.21886 5.33106 4.21886 6.02978C4.20967 6.75609 4.77048 7.37207 5.41405 7.37207ZM10.7807 6.05619C10.7807 6.74114 10.24 7.37201 9.60912 7.37201C8.97825 7.37201 8.4375 6.76818 8.4375 6.05619C8.4375 5.37124 8.97825 4.74037 9.60912 4.74037C10.24 4.74037 10.7807 5.34421 10.7807 6.05619Z" fill="gray"></path></svg>
                  </div>
                  </div>
                  <p className='textChatInGloboU'>Venis a comer?</p>
                  <p className='hourGlobo'>
                    22:43
                  </p>
                </div>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Saliendo</p>
                  <p className='hourGlobo'>
                    22:57
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Ya llego en 15</p>
                  <p className='hourGlobo'>
                    22:57
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='colitaChatU'></div>
                  ...
                  <p className='textChatInGloboU'>Anda con cuidado</p>
                  <p className='hourGlobo'>
                    23:04
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Avisame cuando llegues</p>
                  <p className='hourGlobo'>
                    23:04
                  </p>
                </div>
        ...
        <div>
          <input type='radio' id='chat2' name='chat1' className='showChatText'/>
          <div className='verChat'>
            <div className='bgFondo'></div>
            <div className='bgChat'></div>
            <div className='containerChat'>
              <header className='headerBigChat'>
                ...
                <div className='chatName'>
                  <h4 className='chatNameBig'>Mariano</h4>
                  <p className='lastConnect'>últ. vez hoy a la(s) 19:36</p>
                </div>
                <div className='chatOptions'>
                  <div className='videoOptions'>
                    <span>
              ...
              <div className='chatIndividual'>
                <div className='chatI'>
                  ...
                  <div className='colitaChatI'></div>
                  <p className='textChatInGloboI'>Hablamos más tarde</p>
                  <p className='hourGlobo'>
                    9:20
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Ya casi termino esto</p>
                  <p className='hourGlobo'>
                    18:32
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Me mataron en la facultad hoy</p>
                  <p className='hourGlobo'>
                    19:34
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Me fui a dormir</p>
                  <p className='hourGlobo'>
                    19:35
                  </p>
                </div>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Chango</p>
                  <p className='hourGlobo'>
                    22:50
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Estás?</p>
                  <p className='hourGlobo'>
                    22:50
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Ya somos 14</p>
                  <p className='hourGlobo'>
                    22:52
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Mañana se juega a la pelota, vas?</p>
                  <p className='hourGlobo'>
                    22:52
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
        ...
        <div>
          <input type='radio' id='chat3' name='chat1' className='showChatText'/>
          <div className='verChat'>
            <div className='bgFondo'></div>
            <div className='bgChat'></div>
            <div className='containerChat'>
              <header className='headerBigChat'>
                ...
                <div className='chatName'>
                  <h4 className='chatNameBig'>Dai</h4>
                  <p className='lastConnect'>en línea</p>
                </div>
                <div className='chatOptions'>
                  <div className='videoOptions'>
                    <span>
              ...
              <div className='chatIndividual'>
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Hola dai, que hacen este finde</p>
                  <p className='hourGlobo'>
                    20:44
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Hola luis, como estás?</p>
                  <p className='hourGlobo'>
                    21:07
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>El domingo vamos a comer asado en casa, vienen?</p>
                  <p className='hourGlobo'>
                    21:07
                  </p>
                </div>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Que rico!</p>
                  <p className='hourGlobo'>
                    21:15
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Llevo postre</p>
                  <p className='hourGlobo'>
                    21:15
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Si, si vamos con la gabi</p>
                  <p className='hourGlobo'>
                    21:16
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Los espero</p>
                  <p className='hourGlobo'>
                    21:22
                  </p>
                </div>
        ...
        <div>
          <input type='radio' id='chat4' name='chat1' className='showChatText'/>
          <div className='verChat'>
            <div className='bgFondo'></div>
            <div className='bgChat'></div>
            <div className='containerChat'>
              <header className='headerBigChat'>
                ...
                <div className='chatName'>
                  <h4 className='chatNameBig'>Gabriela</h4>
                  <p className='lastConnect'>últ. vez hoy a la(s) 20:46</p>
                </div>
                <div className='chatOptions'>
                  <div className='videoOptions'>
                    <span>
              ...
              <div className='chatIndividual'>
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Tengo una nueva receta de cuadraditos de limón!</p>
                  <p className='hourGlobo'>
                    20:40
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="#4ba9d2" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Siii!!!</p>
                  <p className='hourGlobo'>
                    20:42
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Ya tenemos nueva actividad juntos!</p>
                  <p className='hourGlobo'>
                    20:42
                  </p>
                </div>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Dale, mañana no juntamos y preparamos</p>
                  <p className='hourGlobo'>
                    20:43
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="#4ba9d2" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Los de la otra vez estaban ricos</p>
                  <p className='hourGlobo'>
                    20:43
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="#4ba9d2" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Espero que estos no defrauden jaja</p>
                  <p className='hourGlobo'>
                    20:44
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="#4ba9d2" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
        ...
        <div>
          <input type='radio' id='chat5' name='chat1' className='showChatText'/>
          <div className='verChat'>
            <div className='bgFondo'></div>
            <div className='bgChat'></div>
            <div className='containerChat'>
              <header className='headerBigChat'>
                ...
                <div className='chatName'>
                  <h4 className='chatNameBig'>Adolfo</h4>
                  <p className='lastConnect'>últ. vez hoy a la(s) 20:36</p>
                </div>
                <div className='chatOptions'>
                  <div className='videoOptions'>
                    <span>
              ...
              <div className='chatIndividual'>
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Ya vas a ver</p>
                  <p className='hourGlobo'>
                    9:20
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Hoy salgo de hierro!</p>
                  <p className='hourGlobo'>
                    9:20
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Hay que llegar a diamante</p>
                  <p className='hourGlobo'>
                    3:34
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>me duermo</p>
                  <p className='hourGlobo'>
                    3:35
                  </p>
                </div>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Cuando vamos a seguir viendo esequlito?</p>
                  <p className='hourGlobo'>
                    18:50
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Ya me voy a olvidar todo</p>
                  <p className='hourGlobo'>
                    18:51
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Estamos con joa</p>
                  <p className='hourGlobo'>
                    20:23
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>lol ?</p>
                  <p className='hourGlobo'>
                    20:23
                  </p>
                </div>
        ...
        <div>
          <input type='radio' id='chat8' name='chat1' className='showChatText'/>
          <div className='verChat'>
            <div className='bgFondo'></div>
            <div className='bgChat'></div>
            <div className='containerChat'>
              <header className='headerBigChat'>
                ...
                <div className='chatName'>
                  <h4 className='chatNameBig'>Maxi</h4>
                  <p className='lastConnect'>últ. vez hoy a la(s) 18:22</p>
                </div>
                <div className='chatOptions'>
                  <div className='videoOptions'>
                    <span>
              ...
              <div className='chatIndividual'>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Me quedo en casa jaja</p>
                  <p className='hourGlobo'>
                    9:20
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>No hay chance, no quiero volver a enfermarme</p>
                  <p className='hourGlobo'>
                    9:20
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Trola</p>
                  <p className='hourGlobo'>
                    13:34
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Ya me baje tinder de nuevo</p>
                  <p className='hourGlobo'>
                    13:34
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Me volvi a enamorar</p>
                  <p className='hourGlobo'>
                    13:35
                  </p>
                </div>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Vamos a ver cuanto te dura esta</p>
                  <p className='hourGlobo'>
                    13:42
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatI'>
                  ...
                  <p className='textChatInGloboI'>Que no sea tóxica esta vez por favor! Jajaja</p>
                  <p className='hourGlobo'>
                    13:45
                    <svg viewBox="0 0 18 18" height="16" width="18" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px"><title>status-dblcheck</title><path fill="currentColor" d="M17.394,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-0.427-0.388c-0.171-0.167-0.431-0.15-0.578,0.038L7.792,13.13 c-0.147,0.188-0.128,0.478,0.043,0.645l1.575,1.51c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C17.616,5.456,17.582,5.182,17.394,5.035z M12.502,5.035l-0.57-0.444c-0.188-0.147-0.462-0.113-0.609,0.076l-6.39,8.198 c-0.147,0.188-0.406,0.206-0.577,0.039l-2.614-2.556c-0.171-0.167-0.447-0.164-0.614,0.007l-0.505,0.516 c-0.167,0.171-0.164,0.447,0.007,0.614l3.887,3.8c0.171,0.167,0.43,0.149,0.577-0.039l7.483-9.602 C12.724,5.456,12.69,5.182,12.502,5.035z"></path></svg>
                  </p>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>Nunca más!</p>
                  <p className='hourGlobo'>
                    13:46
                  </p>
                </div>
                ...
                <div className='chatU'>
                  ...
                  <p className='textChatInGloboU'>xD</p>
                  <p className='hourGlobo'>
                    13:46
                  </p>
                </div>
