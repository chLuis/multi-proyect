    ...
    return (
        <div className="min-w-0 w-full max-w-[900px] px-4">
            <label className="relative">
                ...
                <input type="text" value={newTask} onChange={(e) => handleToDo(e)} onKeyDown={(e) => handleKeyDown(e)} className="min-w-0 w-full rounded py-2 ps-12 pe-12 bg-black bg-opacity-65 focus:bg-opacity-75" />
