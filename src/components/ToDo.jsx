...
export default function ToDo({dataLoad}) {
    ...
    return (
        <div className="min-w-0 w-full max-w-[900px] min-h-screen px-4 pb-8">
            <label className="relative">
                <span className="absolute -inset-y-1 border-b border-orange-400 h-6 left-2 text-neutral-500 text-nowrap">
                    task:
                </span>
                <input type="text" value={newTask} onChange={(e) => handleToDo(e)} onKeyDown={(e) => handleKeyDown(e)} className="min-w-0 w-full rounded py-2 ps-12 pe-12 bg-black bg-opacity-65 focus:bg-opacity-75" autoFocus />
