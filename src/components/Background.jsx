export default function Background(){
    ...
    <>
        ...
        <span className="fixed top-14 left-[5%] z-10 w-1 h-1 bg-white animate-pulse-star rounded-full"></span>
        <span className="fixed top-14 left-[60%] z-10 w-1 h-1 bg-white animate-pulse-star rounded-full"></span>
        ...
        <span className="fixed top-28 left-[66%] z-10 w-1 h-1 bg-white animate-pulse-star rounded-full"></span>
        <span className="fixed top-20 left-[76%] z-10 w-1 h-1 bg-white animate-pulse-star rounded-full"></span>
        <span className="fixed top-32 left-[80%] z-10 w-1 h-1 bg-white animate-pulse-star rounded-full"></span>
        <span className="fixed top-44 left-[70%] z-10 w-1 h-1 bg-white animate-pulse-star rounded-full"></span>
